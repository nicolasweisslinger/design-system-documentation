...
export const documentation =
  <>
    ...
    <p>The checkbox component we were talking about above is a bit special, because it doesn't need other components.</p>
    <p>Some components, on the other hand, need to have other components <span className="is-italic">inside them,</span> components we call <strong>children</strong>.</p>
    ...
    <p>All the properties stay in the opening tag, and <strong>all the children components go between the opening tag and the closing tag.</strong></p>
  </>
