...
export const documentation =
  <>
    ...
    <p>The Tiles component is a simplified version of a grid. All you need to do is define a number of <code>columns</code> and a <code>space</code> value. All the children components will automatically be laid out in a grid.</p>
